...
SPA 框架是为实现 SPA 而明确设计的框架。在 WebAssembly 之前，所有 SPA 框架都基于 JavaScript。最著名的基于 JavaScript 的 SPA 框架是 Angular、React.js 和 Vue.js。
...
3.  在 JavaScript 端，假设 C# 对象位于名为`dotnetObject`的变量中。然后就可以调用：
