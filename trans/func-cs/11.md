...
我们在前一章开发了一个功能性应用程序。为了在函数式方法中创建更好的代码，我们必须遵循最佳实践规则，并在代码中实现它们。在这一章中，我们将讨论泛函方法的概念，它是一个纯函数，使我们的函数类似于一个数学函数。本章将涉及的主题如下:
...
![Preventing dishonest signatures](graphics/image_11_001.jpg)
...
![Examining the code containing side-effects](graphics/image_11_002.jpg)
...
![Executing the test](graphics/image_11_003.jpg)
