...
![Creating anonymous methods](graphics/image_03_001.jpg)
...
![Creating anonymous methods](graphics/image_03_002.jpg)
...
![Using an anonymous method as an argument](graphics/image_03_003.jpg)
...
![Using an anonymous method as an argument](graphics/image_03_004.jpg)
...
![Lambda expressions](graphics/image_03_005.jpg)
...
![Expression trees and lambda expressions](graphics/image_03_006.jpg)

从前面的截图中，我们有一个包含`{(a * b)}`、`NodeType`包含 Lambda、`Type`包含带有三个模板的`Func`委托的`Body`属性，并且是两个参数。如果我们在变量窗口中展开`Body`信息，我们将得到类似于下面截图所示的结果:

![Expression trees and lambda expressions](graphics/image_03_007.jpg)
...
![Expression trees and lambda expressions](graphics/image_03_008.jpg)
...
![Expression trees and lambda expressions](graphics/image_03_009.jpg)
...
![Subscribing for events using lambda expressions](graphics/image_03_010.jpg)
...
![Using the event keyword](graphics/image_03_011.jpg)
...
![Using the event keyword](graphics/image_03_012.jpg)
...
![Using EventHandler or EventHandler<T>](graphics/image_03_013.jpg)
...
![First-class functions](graphics/image_03_014.jpg)
...
![First-class functions](graphics/image_03_015.jpg)
...
![Closure](graphics/image_03_016.jpg)
