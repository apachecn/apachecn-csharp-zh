...
![](assets/d1ab6cee-dd3b-4f28-88ee-079e9a8547ff.png)
...
![](assets/72db35ce-7a4d-42ef-a52b-8b60d333a7a8.png)
...
![](assets/bda2449a-5aa4-4ac5-acf2-adb328a47f44.png)

在撰写本文时，由于目前 ML.NET 的限制，ONNX 支持仅用于使用预先存在的模型进行评分。 本例中包含的预训练模型可以在`assets/model`文件夹中找到。
