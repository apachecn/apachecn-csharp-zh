...
![](assets/9759fb4f-f8f5-4bb0-93db-cd76f0ff7971.png)
...
![](assets/f4d37e52-1dcc-4cca-8fd1-b899579f0d6a.png)
...
在这个应用程序中使用的培训器也使用 SDCA，但使用逻辑回归变化，在本章前面讨论过。
...
![](assets/c49ce931-dac3-4c89-a977-ada86e7ab1a7.png)
...
如前所述，对于这个应用程序，我们是在本章前面完成的工作的基础上构建的。 同样，在本文中，我们将只关注为该应用程序更改的代码。
...
![](assets/fb4d71a8-e7cc-4b33-bb07-776c6e17aa3b.png)
...
![](assets/a9168326-ca8b-49d0-b37b-614cfaf918c1.png)
