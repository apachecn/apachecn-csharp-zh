...
![Populating the level](graphics/5909_04_01.jpg)
...
![Populating the level](graphics/5909_04_02.jpg)
...
![Populating the level](graphics/5909_04_03.jpg)
...
![Populating the level](graphics/5909_04_04.jpg)

现在，将实体拖到视口中以生成它，就像生成**总部**一样。 生成后，将**Team**属性设置为**Red**，然后对 Blue Team 重复上述过程:

![Populating the level](graphics/5909_04_05.jpg)
