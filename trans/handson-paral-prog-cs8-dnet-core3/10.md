...
![](assets/155f0014-8b54-4083-9c66-17855f669651.png)
...
![](assets/031f99a8-0724-4485-b449-1f9e6c1e79cf.png)
...
![](assets/ea22ccb9-4c0b-4bac-a5b9-897cb63ec33c.png)

黄色箭头显示代码执行的当前位置。 将鼠标悬停在 Parallel Stacks 窗口中的任何方法上，将打开 Threads 窗口，其中包含当前正在执行的线程的信息:

![](assets/f462501f-0139-4c9d-af35-75e74a3a1790.png)

我们可以通过双击它切换到任何其他方法:

![](assets/4935cbee-90c0-4d42-aeb3-84678f412331.png)

我们也可以切换到方法视图来查看完整的调用堆栈:

![](assets/ffd48e2f-51fe-4ed0-b50b-251cd280037d.png)
...
![](assets/3d7406d4-8e16-454e-a154-b53080dc26e2.png)

从下面的截图中可以看到，目前有 10 个任务正在执行，每个任务都显示在当前执行的行中。

悬停在任何方法上，都可以看到所有正在运行的任务的状态:

![](assets/2e011cbb-a479-477a-a1f6-37f32a3799a0.png)

Tasks 窗口帮助我们分析由于缓慢的方法调用或死锁引起的应用程序中的性能问题。
...
![](assets/2aa59640-50d8-47ec-ae8f-c45cefea0358.png)
...
![](assets/193721e2-bfcb-468a-a793-5871a25f28b5.png)
...
![](assets/3b4edc2d-78ac-477b-a15b-34dcd42de015.png)
...
![](assets/fe634fe0-30d4-4624-875c-63f3402e3a28.png)
...
![](assets/54c81a5c-71a2-4f56-8c7d-d1c69529ee7e.png)
