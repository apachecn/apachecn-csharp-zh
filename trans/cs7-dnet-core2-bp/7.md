...
![](assets/31b46271-09a2-4101-a3fb-6805ce937eba.png)
...
最后，在我们继续之前，我们希望 Azure 函数向调用应用程序返回一个单独的`True`或`False`值。修改`return`对你的功能的陈述，做到这一点:
...
9.  如果一切顺利，当您运行 ASP.NET 核心 MVC 应用程序时，您将看到下面的页面。登录表单显然完全不起作用:
