...
在本章中，我们将学习使用 TPL 执行异步操作。我们将学习什么是任务，介绍创建任务的不同方法，以及如何将任务组合在一起。我们还将讨论如何将传统 APM 和 EAP 模式转换为使用任务，如何正确处理异常，如何取消任务，以及如何处理同时执行的多个任务。此外，我们将了解如何正确处理 Windows GUI应用中的任务。
