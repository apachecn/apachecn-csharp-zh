...
我们的解决方案将包含一个项目，该项目将是一个 ASP.NETCore 应用，目标是.NET Framework Core 3.1 或更高版本。现在我们将讨论如何访问晨星 API。
...
*   [https://docs.microsoft.com/en-us/azure/app-service/app-service-web-get-started-dotnet](https://docs.microsoft.com/en-us/azure/app-service/app-service-web-get-started-dotnet) 涵盖在 Azure 中创建.NETCore 应用。
