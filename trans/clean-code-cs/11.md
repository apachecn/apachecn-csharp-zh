...
![](assets/5a4fd4a9-d664-4351-985d-fc1b37687b68.png)
...
![](assets/adc0e574-a40d-4c5f-b12b-397bf35ff3b9.png)
...
我们将编写一个示例，将一个操作包装在一个`try`/`catch`块中。`try`和`catch`都会向控制台输出一个字符串。创建名为`CH10_AddressingCrossCuttingConcerns`的新.NET 4.8 控制台应用程序。然后，添加一个名为`DecoratorPattern`的文件夹。添加一个名为`IComponent`的新接口：
...
![](assets/664bec75-738c-4c02-b795-f06f6e2d0a52.png)
...
![](assets/7a2acc31-3b52-44c5-8ddf-421e7e7aba54.png)
...
![](assets/ff58bd4b-08a3-41b8-bdba-bef5e252a020.png)
...
![](assets/2169d706-6075-45f7-a0c7-668e69855318.png)
...
![](assets/847bde47-fa68-4381-aba1-0c89cd4987ae.png)
