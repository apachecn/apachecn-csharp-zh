...
此外，当系统运行时面临异常时，它只是终止程序。所以，现在你明白为什么你应该处理异常了。如果您没有做到这一点，您的应用程序可能会在运行过程中崩溃。我确信你个人不喜欢在使用时崩溃的程序，所以我们在编写无异常软件时必须小心。让我们看一个例子，如果不处理异常，系统运行时会发生什么:
...
![](assets/19a3ed57-7485-4785-872d-de991b0338f1.png)
...
![](assets/32173a85-0984-4cbd-acbb-cb9eb559c8e1.png)
...
![](assets/9295d985-106f-47ac-9530-b2818991d2b0.png)
...
| `IndexOutOfRangeException` | 当应用程序试图使用不存在的数组的索引时，会引发此异常。 |
...
![](assets/2ae2fd64-2e62-4365-aa7c-23b2e7104ae7.png)
...
![](assets/b38a2822-1170-4403-8bfe-b6e93aea6a89.png)
...
![](assets/0742e721-1391-4da1-89eb-707e2c898206.png)
...
我们都梦想有一个完美的世界，没有错误或意外情况，但在现实中，这是不可能的。软件开发也不是没有错误和异常。软件开发人员不希望他们的软件崩溃，但意外的异常时有发生。因此，处理这些异常对于开发优秀的软件是必要的。在这一章中，我们熟悉了软件开发中的异常情况。我们还学习了如何处理异常、为什么需要处理异常、如何创建自定义异常以及许多其他重要主题。在应用程序中实现异常处理时，请尝试遵循最佳实践，以便获得平稳运行的应用程序。*