...
2.  Hover your mouse pointer over the error, and note a compile-time check is shown as an error message, as shown in *Figure 3.1*:
    ...
    <figure class="mediaobject">![Graphical user interface, text, application, email  Description automatically generated](../Images/B17442_03_01.png)</figure>
...
<figure class="mediaobject">![Text  Description automatically generated](../Images/B17442_03_02.png)</figure>
