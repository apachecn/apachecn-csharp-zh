...
6.  Run the code and view the result, as shown in *Figure 9.1*:
    ...
    <figure class="mediaobject">![Text  Description automatically generated](../Images/B17442_09_01.png)</figure>
...
3.  Run the code and view the result, as shown in *Figure 9.2*:
    ...
    <figure class="mediaobject">![](../Images/B17442_09_02.png)</figure>
...
<figure class="mediaobject">![Graphical user interface, text, application, email  Description automatically generated](../Images/B17442_09_03.png)</figure>
