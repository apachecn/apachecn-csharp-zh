...
![](assets/a92e6211-c9db-44ae-8dde-6c0cff7213f5.png)
...
![](assets/70619b88-ea6e-4cbd-814b-22c43ab44ae0.png)
...
![](assets/fb23aa69-1daf-4775-b51f-5afe3c7d9bc9.png)

前面的快照描述了我们的 FlixOne web 应用程序，其文件夹结构如下：
...
在前面的代码片段中，我们有一个书面语句，`services.AddTransient<IHelper, Helper>();`。这样，我们将向应用程序添加一个临时服务。我们已经在[第 5 章](05.html)中讨论了*控制反转*部分，*实现设计模式-.Net 核心*。
...
![](assets/18dae3fc-bf2b-4296-be43-c0447ffc8d47.png)
...
![](assets/8c9cb2fd-c823-4cd2-bcac-143a3fd6ff2c.png)
...
执行应用程序，从主屏幕单击产品，然后单击产品折扣列表。从这里，您将看到以下屏幕：

![](assets/b228c14a-47b4-427b-9f13-b4bff9507521.png)
