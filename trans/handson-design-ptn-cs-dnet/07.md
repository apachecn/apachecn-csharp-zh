...
以下是由于应用程序中的重大更改而产生的挑战。这也是将控制台应用程序升级为 web 应用程序的主要扩展的结果：
...
4.  为 Web 应用程序（模型视图控制器）模板选择 ASP.NET Core 2.2：
...
![](assets/b2f40509-4128-4d60-864b-84b5bc9fc064.png)
