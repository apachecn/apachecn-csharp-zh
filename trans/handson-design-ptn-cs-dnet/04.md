...
![](assets/9597d7f3-ef49-419f-b295-077228d9471e.png)
...
![](assets/8cf03f40-50e7-4459-8209-60388b3b9a71.png)
...
![](assets/fe27049f-ade1-485f-a255-bcd56290bbc6.png)

下图显示了从名为`Chester`的书籍集合中读取的两条线程：

![](assets/b2b80704-df53-4c39-b3c5-e7176a6c2467.png)

下图显示**ThreadA**通过增加`4`数量更新书籍，而**ThreadB**通过增加`3`数量更新书籍：

![](assets/b5a8650f-1f3d-4414-9109-f15046958d42.png)

然后，当更新的书籍被持久化回集合时，我们得到了一个未知的数量，如下图所示：

![](assets/f4a99992-46d0-4eb7-a464-d82126476461.png)
...
![](assets/2609a169-37d7-4a74-8aac-65d25b8c1a77.png)
...
![](assets/10cf9ef0-f9f0-459d-969c-1ded9e9e093e.png)
...
![](assets/2b227f12-9b64-4501-9190-7385cf1f6d34.png)

然后，应用程序循环执行这些命令，直到收到退出命令。以下屏幕截图说明了其功能：

![](assets/23375dec-001c-4064-9278-19da5d745827.png)
