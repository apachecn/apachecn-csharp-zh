...
如果您想使用 Visual Studio 在应用中设置应用洞察，您可能会发现此 Microsoft教程非常有用：[https://docs.microsoft.com/en-us/azure/azure-monitor/learn/dotnetcore-quick-start# configure-app insights sdk](https://docs.microsoft.com/en-us/azure/azure-monitor/learn/dotnetcore-quick-start# configure-app-insi)。
...
综上所述，我们列出的所有需求都汇聚到了本书中描述的大多数先进技术，如云服务、可伸缩 web应用、分布式/可伸缩数据库、Docker、Kubernetes、SOA 和微服务架构。
...
前面列表中的前两点将与*中的其他分布式处理技术一起详细讨论。NETCore如何处理微服务？*第 5 章*的*部分*将微服务架构应用于您的企业应用*。
