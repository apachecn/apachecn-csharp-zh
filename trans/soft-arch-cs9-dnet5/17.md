...
<figure class="mediaobject">![](../Images/B16756_17_01.png)</figure>
...
<figure class="mediaobject">![](../Images/B16756_17_02.png)</figure>
...
<figure class="mediaobject">![](../Images/B16756_17_03.png)</figure>
...
<figure class="mediaobject">![](../Images/B16756_17_04.png)</figure>

图 17.4：遗传样本的深度

您可以在下面的屏幕截图中看到，考虑到还有三个其他类可以改变其行为，较深的类具有更差的度量：

<figure class="mediaobject">![](../Images/B16756_17_05.png)</figure>
...
<figure class="mediaobject">![](../Images/B16756_17_06.png)</figure>

图 17.6：类耦合示例

一旦您计算了前面设计的代码度量，您将看到`ProcessData()`方法调用`ExecuteTypeA()`、`ExecuteTypeB()`和`ExecuteTypeC()`的类耦合实例数等于三个（`3`：

<figure class="mediaobject">![](../Images/B16756_17_07.png)</figure>

图 17.7：等级耦合度量

一些论文指出，类耦合实例的最大数量应该是 9 个（`9`。由于聚合是比继承更好的实践，接口的使用将解决类耦合问题。例如，具有以下设计的相同代码将为您提供更好的结果：

<figure class="mediaobject">![](../Images/B16756_17_08.png)</figure>

图 17.8：异径级联轴器

请注意，在设计中使用接口将允许您在不增加解决方案的类耦合的情况下增加执行类型的数量：

<figure class="mediaobject">![](../Images/B16756_17_09.png)</figure>
...
<figure class="mediaobject">![](../Images/B16756_17_10.png)</figure>
