...
Visual Studio for Mac 的核心是用于重构和智能感知的罗斯林编译器。构建引擎是 MSBuild，调试器引擎对于 Xamarin 和是相同的.NETCore应用。Mac 的 Xamarin 开发和 Visual Studio 的软件需求如下:
