...
![Figure 2.1 – List of Uno Platform project templates in the new project dialog ](image/Author_Figure_2.01_B17132.jpg)
...
![](image/Author_Figure_2.02_B17132.jpg)
 ...
 *![Figure 2.3 – Removing the Skia.Tizen head from the solution ](image/Figure_2.03_B17132.jpg)
...
![Figure 2.4 – HelloWorld project in File Explorer ](image/Figure_2.04_B17132.jpg)
...
![Figure 2.5 – Missing components warning in Visual Studio ](image/Figure_2.05_B17132.jpg)
...
![Figure 2.6 – Configuration, architecture, startup project, and target machine options in Visual Studio ](image/Figure_2.06_B17132.jpg)
...
![Figure 2.7 – List of Android emulators in Visual Studio ](image/Figure_2.07_B17132.jpg)

图 2.7 - Visual Studio 中的 Android 模拟器列表

然后，您可以通过单击绿色箭头或点击*F5*来启动项目。 应用程序将构建，你应该看到类似于*图 2.8*的内容:

![Figure 2.8 – Screenshot of the HelloWorld app running on Windows 10 ](image/Author_Figure_2.08_B17132.jpg)
...
对于 Android 开发，有多种不同的方法来尝试和运行应用程序。 一种可能是使用 Visual Studio 附带的 Android 模拟器。 为此，只需从目标列表下拉列表中选择 Android 模拟器，如图*图 2.7*所示。
...
因为调试 Uno 平台应用程序的 WASM 构建将在 Visual Studio 和 Visual Studio for Mac 之外进行，所以我们将在下一节中讨论这个问题。
...
![Figure 2.9 – RUN AND DEBUG view of Visual Studio Code ](image/Figure_2.09_B17132.jpg)
...
![Figure 2.10 – Terminal output of the development server ](image/Figure_2.10_B17132.jpg)
...
![Figure 2.11 – HelloWorld app running in the browser ](image/Figure_2.11_B17132.jpg)
...
![Figure 2.12 – Our HelloWorld app with XAML Hot Reload changes ](image/Author_Figure_2.12_B17132.jpg)
...
![Figure 2.13 – Break all button ](image/Figure_2.13_B17132.jpg)
...
如果你运行应用程序的 UWP 头并单击按钮，文本将会从桌面 c#改为**Hello !** 因为 UWP 头只在设置**NETFX_CORE**符号时才被编译。 现在，如果你在 Android 或 iOS 模拟器(或设备)上运行该应用程序并点击按钮，它将显示**Hello from c# on mobile**! 因为 Android 和 iOS 头是用**__ANDROID__**或**__IOS__**符号编译的。
...
![Figure 2.14 – Table of namespace prefixes, the supported platforms, and their namespace URIs ](image/Figure_2.14_B17132.jpg)
...
![Figure 2.15 – HelloWorld app running using WASM (left) and using UWP (right) ](image/Figure_2.15_B17132.jpg)

图 2.15 - HelloWorld 应用程序使用 WASM(左)和 UWP(右)运行
...
![Figure 2.16 – The Add a new project dialog in Visual Studio ](image/Author_Figure_2.16_B17132.jpg)
...
![Figure 2.17 – HelloWorld solution view ](image/Figure_2.17_B17132.jpg)
...
![Figure 2.18 – Add | Reference… option for the UWP head ](image/Figure_2.18_B17132.jpg)

图 2.18 -为 UWP 头添加| Reference…选项

在点击**Reference…**后，一个新的对话框会打开，你可以在其中选择要添加的 Reference。 在我们的例子中，您需要选择项目，如图*图 2.19*所示:

![Figure 2.19 – Reference Manager for the UWP head ](image/Figure_2.19_B17132.jpg)
...
除了 Uno Platform Prism 应用模板，还有一个 Uno Platform 模板，用于为**WinUI 3**构建应用。 然而，你可以创建一个 Uno 平台应用，使用 WinUI 3 预览版的 Windows 10。 要使用 WinUI 3 创建 Uno 平台应用程序，在新项目对话框中，选择**跨平台应用程序(WinUI) (Uno 平台)**模板。
