...
![](assets/13816e5a-608c-4352-8189-2953a133adc6.png)

我们将项目命名为**MeTracker**：

![](assets/d2bbd5fd-eed3-423d-8dc4-ad8b6f8e4ced.png)

我们将使用**空白**模板，为**Android**和**iOS**平台构建：

![](assets/8f360153-a036-4102-98fc-a083e46a16a7.png)

确保您正在使用 Android 版本 Oreo（API 级别 26）或更高版本进行编译。我们可以在项目的属性中，在应用程序**选项卡下进行设置。**
...
![](assets/21c68bd8-8d2c-4574-bb2f-21e1fcbc11ba.png)
...
![](assets/a57717aa-9f8c-4deb-8940-1ff9f85ace6c.png)
...
至此，我们完成了 iOS 应用程序的跟踪部分。现在，我们将为 Android 实现背景跟踪。之后，我们将可视化数据。
...
![](assets/59dd8ab8-c768-4393-81f4-e25e25012d77.png)
