 ...
 **![](assets/6f12832c-5e48-4864-b8e7-54a6cc6037a9.png)

2.  在搜索字段中输入 Xamarin.Forms 并选择移动应用程序（Xamarin.Forms）模板，如以下屏幕截图所示：

![](assets/a2ecd60a-5030-46ee-80d0-6f45a92a7eaf.png)

3.  通过命名项目完成向导的下一步。在这种情况下，我们将调用我们的应用程序`Swiper`。单击“创建”转到下一个对话框，如以下屏幕截图所示：

![](assets/e74d1808-18d2-4e70-89ba-af9bcdc32c7c.png)
...
![](assets/1826ade1-9798-43db-a6ff-b50b0768a198.png)
...
![](assets/a8897e59-7b8e-4647-bade-233d32e12f20.png)

这将在 Visual Studio 中打开 NuGet 软件包管理器，如以下屏幕截图所示：

![](assets/cc7792d2-9861-4010-b1b5-a5b1816c7945.png)
...
![](assets/3f852544-3f70-41b1-8085-cf91eb3dd14b.png)
...
![](assets/3532f908-af0b-4d3c-8066-c61a90527dda.png)

这将为 UI 添加一个 XAML 文件和一个 C 代码隐藏文件。它应该类似于以下屏幕截图：

![](assets/2c5fd2df-35e0-4894-bbf2-2db7c950e6fa.png)
...
![](assets/dbecc7c3-eaeb-43c0-ab03-3dbcff3e2f66.png)
...
![](assets/67ba78cc-c951-43fe-9920-d25fdcd67683.png)
